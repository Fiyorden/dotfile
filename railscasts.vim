...
endfun
" }}}
call <SID>X("Boolean","cc7833","","none")
...
call <SID>X("Comment","bc9458","","italic")
call <SID>X("Conditional","da4939","","none")
...
call <SID>X("ErrorMsg","e6e1dc","","none")
call <SID>X("Exception","da4939","","none")
call <SID>X("Float","a5c261","","none")
call <SID>X("FoldColumn","e2e4e5","","none")
call <SID>X("Folded","e2e4e5","","none")
call <SID>X("Function","ffc66d","","none")
...
call <SID>X("ModeMsg","e6e1dc","","none")
call <SID>X("MoreMsg","e2e4e5","","none")
call <SID>X("NonText","e6e1dc","","none")
call <SID>X("Normal","e6e1dc","111111","none")
call <SID>X("Number","a5c261","","none")
call <SID>X("Operator","da4939","","none")
call <SID>X("PMenu","dddddd","545658","none")
call <SID>X("PMenuSbar","dddddd","c0c0ff","none")
call <SID>X("PMenuSel","88dd88","949698","none")
call <SID>X("PMenuThumb","dddddd","2b2b2b","none")
call <SID>X("PreCondit","cc7833","","none")
call <SID>X("PreProc","e6e1dc","","none")
call <SID>X("Question","e6e1dc","","none")
call <SID>X("Repeat","da4939","","none")
call <SID>X("Search","e2e4e5","2b2b2b","italic,underline")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","da4939","","none")
call <SID>X("SpecialChar","da4939","","none")
call <SID>X("SpecialComment","da4939","","none")
call <SID>X("SpecialKey","e2e4e5","","none")
call <SID>X("SpellBad","d70000","","underline")
...
call <SID>X("StatusLine","e6e1dc","","none")
call <SID>X("StatusLineNC","e6e1dc","","none")
call <SID>X("StorageClass","da4939","","none")
call <SID>X("String","a5c261","","none")
call <SID>X("Structure","da4939","","none")
call <SID>X("TabLine","e2e4e5","","none")
call <SID>X("TabLineFill","e2e4e5","","none")
call <SID>X("TabLineSel","e2e4e5","","none")
call <SID>X("Tag","da4939","","none")
call <SID>X("Title","ffffff","","none")
call <SID>X("Todo","e6e1dc","","none")
